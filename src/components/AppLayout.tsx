...
import { 
  ...
  Droplets, Sprout, Home, Leaf, Heart, ArrowRight, Users, Target, Eye, Shield, Award,
  ...
  Filter, Calendar, ChevronLeft, ChevronRight, Image as ImageIcon
} from 'lucide-react';
...
const IMAGES = {
  logo: "https://d64gsuwffb70l.cloudfront.net/6891fba9e84754e0b0fc9f86_1768205885796_f2d4cfcb.jpg",
	...
	borehole2: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769749773474-WhatsApp_Image_2026-01-24_at_1.37.05_PM__3_.jpeg",
	waterworks3: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1770540396401-borehole_drilling_2.jpeg",
	waterworks4: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1770540401643-borehole_drilling1.jpeg",
	waterworks5: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1776666526272-Wassadu_whatsOnGambia_project_2.jpeg",
	ecovillage1: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769749187043-WhatsApp_Image_2026-01-24_at_1.37.33_PM__2_.jpeg",
	ecovillage2: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769749190014-WhatsApp_Image_2026-01-24_at_1.37.35_PM.jpeg",
	ecovillage3: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769749188424-WhatsApp_Image_2026-01-24_at_1.37.33_PM.jpeg",
	irrigation1: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1770537226868-seedlings1.jpeg",
	irrigation2: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769991445202-irrigation_house.jpeg",
	irrigation3: "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1770537883260-transporting_oranges.jpeg",
	agriculture4:"https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1770532379503-seedlings2.jpeg",
	community1:  "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769750135779-WhatsApp_Image_2026-01-24_at_1.39.45_PM.jpeg",
	community2:  "https://ousrwhwfrwlrnheoavzk.supabase.co/storage/v1/object/public/blog-images/1769750136794-WhatsApp_Image_2026-01-24_at_1.39.47_PM__1_.jpeg",
...
function usePageSettings() {
  ...
  React.useEffect(() => {
    supabase.from('page_settings').select('*').then(({ data }) => {
      if (data) {
        const map: Record<string, any> = {};
        data.forEach((row: any) => { map[row.page] = row; });
        setSettings(map);
      }
    });
  }, []);
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:contact@bati-ngalun.com" className="text-gray-300 hover:text-white text-sm">admin@bati-ngalun.com</a>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="h-5 w-5 text-[#4A90E2] flex-shrink-0 mt-0.5" />
                <span className="text-gray-300 text-sm">Marakissa, The Gambia<br />West Africa</span>
              </li>
            </ul>
...
const SectionPosts: React.FC<{ section: string; title?: string }> = ({ section, title = 'Latest Updates' }) => {
    ...
    <section className="py-16 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {posts.map((post) => (
            <div key={post.id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all border border-gray-100 group flex flex-col">
                ...
                {post.content && (
                  <div className="flex-1">
                    <p className="text-gray-600 text-sm leading-relaxed">
                      {expanded === post.id ? post.content : post.content.length > 150 ? post.content.substring(0, 150) + '...' : post.content}
                    </p>
...
// Home Page
const HomePage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  ...
  const heroSlides = [
    ...
    { image: IMAGES.agriculture4, title: 'Agricultural Innovation', subtitle: 'Empowering farmers with modern irrigation solutions' },
	{ image: IMAGES.community1, title: 'Bati-ngalun foundation', subtitle: 'Tree Planting for Climate and Community Development' },  
  ];
  ...
  const [featuredProjects, setFeaturedProjects] = React.useState<{ image: string; title: string; category: string; description: string }[]>([]);
    ...
    supabase
      ...
      .then(({ data }) => {
        const categoryLabels: Record<string, string> = {
          water: 'Water Projects', realestate: 'Real Estate',
          agriculture: 'Agriculture', social: 'Social Impact', news: 'News',
        };
        setFeaturedProjects((data || []).map((p: any) => ({
  ...
  const displayedFeatured = featuredLoaded && featuredProjects.length === 0
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
			...
			<div className="text-center mt-10">
			  <button 
			    onClick={() => window.open('https://blog.bati-ngalun.com', '_blank')}
...
// About Page
const AboutPage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  const values = [
    ...
    <div>
      <section className="relative py-20 bg-gradient-to-r from-[#1a5f2a] to-[#0077BE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">{ps.get('about', 'hero_title', 'About Us')}</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">{ps.get('about', 'hero_subtitle', 'Learn about Bati-Ngalun Company Limited, our mission, vision, and the team driving sustainable development in The Gambia.')}</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <img src={ps.get('about', 'hero_image', IMAGES.community1)} alt="About us" className="rounded-xl shadow-lg" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-lg">
              <img src={IMAGES.team} alt="Leadership Team" className="w-full h-auto object-contain" />
              <div className="p-8">
...
// Waterworks Page
const WaterworksPage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  const services = [
	...
	{ icon: Sprout, title: 'Drip Irrigation Systems', description: 'Precision water delivery solutions designed to maximize crop yield while reducing water waste through efficient root-zone irrigation.' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">{ps.get('waterworks', 'hero_title', 'Sustainable Water Solutions for The Gambia')}</h1>
              <p className="text-xl text-white/90 mb-8">{ps.get('waterworks', 'hero_subtitle', 'From borehole drilling to pump installation and maintenance, we provide comprehensive water solutions.')}</p>
              <div className="flex flex-wrap gap-4">
            ...
            <div><img src={ps.get('waterworks', 'hero_image', IMAGES.borehole1)} alt="Borehole Drilling" className="rounded-xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
...
// Real Estate Page
const RealEstatePage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  const services = [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">{ps.get('realestate', 'hero_title', 'Sustainable Real Estate Development')}</h1>
              <p className="text-xl text-white/90 mb-8">{ps.get('realestate', 'hero_subtitle', 'Building eco-friendly communities that combine modern living with environmental sustainability.')}</p>
              <div className="flex flex-wrap gap-4">
          ...
          <div><img src={ps.get('realestate', 'hero_image', IMAGES.ecovillage1)} alt="Eco-Village" className="rounded-xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
...
// Agriculture Page
const AgriculturePage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  const services = [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">{ps.get('agriculture', 'hero_title', 'Agricultural Innovation for Food Security')}</h1>
              <p className="text-xl text-white/90 mb-8">{ps.get('agriculture', 'hero_subtitle', 'Empowering Gambian farmers with modern irrigation systems and sustainable practices.')}</p>
              <div className="flex flex-wrap gap-4">
            ...
            <div><img src={ps.get('agriculture', 'hero_image', IMAGES.irrigation1)} alt="Agricultural Irrigation" className="rounded-xl shadow-2xl" /></div>
...
// Foundation Page
const FoundationPage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  const programs = [
    ...
    { icon: Leaf, title: 'Environmental Restoration', description: 'Tree planting and watershed protection initiatives.', impact: '5000+ trees planted' },
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-4">{ps.get('foundation', 'hero_title', 'Social Enterprise for Community Impact')}</h1>
              <p className="text-xl text-white/90 mb-8">{ps.get('foundation', 'hero_subtitle', 'As a registered social enterprise, we reinvest part of our profits into community development programs.')}</p>
              <div className="flex flex-wrap gap-4">
                ...
                <a href="https://wa.me/2202167819?text=Hello,%20I%20am%20interested%20in%20supporting%20the%20Bati-Ngalun%20Foundation." target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-[#25D366] text-white font-semibold rounded-lg hover:bg-[#1da851] transition-colors">Contact Foundation</a>
              </div>
            </div>
            <div><img src={ps.get('foundation', 'hero_image', IMAGES.community1)} alt="Community Impact" className="rounded-xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-rose-600 to-rose-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[{ value: '20+', label: 'Communities Served' }, { value: '1000+', label: 'People Impacted' }, { value: '50+', label: 'Youth Trained' }, { value: '5,000+', label: 'Trees Planted' }].map((stat, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
      ...
      <section className="py-16 bg-white text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="https://wa.me/2202167819?text=Hello,%20I%20would%20like%20to%20support%20the%20Bati-Ngalun%20Foundation." target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 bg-[#25D366] text-white font-semibold rounded-lg hover:bg-[#1da851] transition-colors">WhatsApp Us</a>
          </div>
        </div>
      </section>
    </div>
...
// Projects Page
const ProjectsPage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  ...
  const staticProjects = [
    { id: 's1', title: 'Bati-Ngalun Ecovillage', category: 'realestate', image: IMAGES.ecovillage1, location: 'Marakissa', timeline: '2023 - Ongoing', description: 'Sustainable community with 50+ eco-friendly housing units.', impact: '200+ residents' },
    { id: 's2', title: 'The Irrigation House – Gambia', category: 'agriculture', image: IMAGES.irrigation2, location: 'Brikama', timeline: '2025 - 2030', description: 'Retail enterprise for the importation of agricultural and irrigation materials.', impact: '200+ farmers trained' },
    { id: 's3', title: 'Civil Service Drilling Project 2026', category: 'water', image: IMAGES.borehole1, location: 'Multiple Locations', timeline: '2025 - 2026', description: 'Large-scale borehole drilling for civil servants.', impact: '300+ civil servants' },
    { id: 's4', title: 'Kerewan Community Water Project', category: 'water', image: IMAGES.borehole2, location: 'North Bank Region', timeline: '2023', description: 'Clean water for 500+ residents.', impact: '500+ people' },
    { id: 's5', title: 'Youth Skills Training Center', category: 'social', image: IMAGES.community2, location: 'Banjul', timeline: '2022 - Ongoing', description: 'Vocational training facility for young Gambians.', impact: '50+ youth trained' },
    { id: 's6', title: 'Sustainable Housing Development', category: 'realestate', image: IMAGES.ecovillage2, location: 'Multiple Locations', timeline: '2024 - Ongoing', description: 'Affordable eco-friendly housing project.', impact: '30 housing units' },
    { id: 's7', title: 'Safe Transportation of Seedlings', category: 'agriculture', image: IMAGES.irrigation3, location: 'Marakissa', timeline: '2022 - Ongoing', description: 'Seedlings carefully transported to planting sites. Proper handling reduces damage and stress on young plants.', impact: '5000+ Seedlings sold' },
    { id: 's8', title: 'From Nursery to Field', category: 'agriculture', image: IMAGES.irrigation1, location: 'Marakissa', timeline: '2022 - Ongoing', description: 'From raising strong seedlings in the nursery to cultivating healthy crops and transporting plants for large-scale planting.', impact: '10000+ seedlings sold' },
    { id: 's9', title: 'Pawpaw Seedlings for Sale', category: 'agriculture', image: IMAGES.agriculture4, location: 'Marakissa', timeline: '2022 - Ongoing', description: 'Quality pawpaw seedlings grown and sold by Bati-Ngalun Company.', impact: '10000+ seedlings sold' },
    { id: 's10', title: 'Borehole Drilling Works', category: 'water', image: IMAGES.waterworks3, location: 'Sanyang', timeline: '2025', description: 'Professional borehole drilling to provide safe and reliable water for the community.', impact: 'Clean & sustainable water supply' },
    { id: 's11', title: 'Borehole Casing and Installation', category: 'water', image: IMAGES.waterworks4, location: 'Provinces', timeline: '2025', description: 'Installation of borehole casing as part of sustainable water supply solutions.', impact: 'Clean & sustainable water supply' },
    { id: 's12', title: 'Solar-Powered Water Project – Wassadu, Foni', category: 'water', image: IMAGES.waterworks5, location: 'Wassadu', timeline: '2026 April', description: 'A solar-powered water system installed in Wassadu, bringing sustainable water access to the community.', impact: 'Lives elevated' },
  ];
  ...
  const adminProjects = adminPosts.map((post) => ({
    ...
    location: '',
    timeline: new Date(post.created_at).toLocaleDateString('en-GB', { month: 'short', year: 'numeric' }),
  ...
  return (
    <div>
      <section className="relative py-20 bg-gradient-to-r from-[#1a5f2a] to-[#0077BE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">{ps.get('projects', 'hero_title', 'Our Projects')}</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">{ps.get('projects', 'hero_subtitle', 'Explore our portfolio of water, real estate, agriculture, and social impact projects.')}</p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredProjects.map((project) => (
              <div key={project.id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all group">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">{project.title}</h3>
                  {project.location && <div className="flex items-center text-sm text-gray-500 mb-2"><MapPin className="h-4 w-4 mr-1" />{project.location}</div>}
                  ...
                  {project.impact && <div className="flex items-center text-sm"><Users className="h-4 w-4 text-[#0077BE] mr-1" /><span className="text-gray-600">{project.impact}</span></div>}
                </div>
              </div>
            ))}
          </div>
...
// Careers Page
const CareersPage: React.FC<{ setCurrentPage: (page: string) => void; ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ setCurrentPage, ps }) => {
  const [expandedJob, setExpandedJob] = useState<number | null>(null);

  const jobs = [
    { id: 1, title: 'Agronomist', department: 'Agronomist expert', location: 'Marakissa', type: 'Full-time', description: 'Agronomist to support farming operations.' },
    { id: 2, title: 'Marketing Officer', department: 'Sales', location: 'Marakissa', type: 'Full-time', description: 'Promote company services across waterworks, real estate, and agriculture by implementing effective marketing strategies and managing social media platforms. Create engaging content, respond to client inquiries, support sales activities, and contribute to branding, promotions, and community outreach initiatives' },
  ...
  return (
    <div>
      <section className="relative py-20 bg-gradient-to-r from-[#1a5f2a] to-[#0077BE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">{ps.get('careers', 'hero_title', 'Join Our Team')}</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">{ps.get('careers', 'hero_subtitle', 'Build your career while making a difference in Gambian communities.')}</p>
        </div>
      </section>
...
// Contact Page
const ContactPage: React.FC<{ ps: { get: (page: string, field: string, fallback: string) => string } }> = ({ ps }) => {
  ...
  const contactInfo = [
    ...
    { icon: Mail, title: 'Email', details: ['admin@bati-ngalun.com'], action: 'mailto:admin@bati-ngalun.com', actionText: 'Send Email' },
    { icon: MapPin, title: 'Office Location', details: ['Marakissa, The Gambia', 'West Africa'], action: 'https://maps.google.com/?q=Marakissa,Gambia', actionText: 'Get Directions' },
  ];
  ...
  return (
    <div>
      <section className="relative py-20 bg-gradient-to-r from-[#1a5f2a] to-[#0077BE]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">{ps.get('contact', 'hero_title', 'Contact Us')}</h1>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">{ps.get('contact', 'hero_subtitle', "Get in touch with our team. We're here to answer your questions.")}</p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Visit us at our office in Marakissa, Kombo Central, West Coast Region, The Gambia</p>
          </div>
          <div className="bg-gray-200 rounded-xl overflow-hidden h-96">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62036.41567285!2d-16.6291!3d13.4549!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xec29c2a1d6e5555%3A0x5c6e5d5e5d5e5d5e!2sMarakissa%2C%20The%20Gambia!5e0!3m2!1sen!2s!4v1234567890" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Bati-Ngalun Office Location" />
          </div>
        </div>
      </section>
...
const AppLayout: React.FC = () => {
  ...
  const renderPage = () => {
    switch (currentPage) {
      case 'home':        return <HomePage        setCurrentPage={setCurrentPage} ps={ps} />;
      case 'about':       return <AboutPage       setCurrentPage={setCurrentPage} ps={ps} />;
      case 'waterworks':  return <WaterworksPage  setCurrentPage={setCurrentPage} ps={ps} />;
      case 'realestate':  return <RealEstatePage  setCurrentPage={setCurrentPage} ps={ps} />;
      case 'agriculture': return <AgriculturePage setCurrentPage={setCurrentPage} ps={ps} />;
      case 'foundation':  return <FoundationPage  setCurrentPage={setCurrentPage} ps={ps} />;
      case 'projects':    return <ProjectsPage    setCurrentPage={setCurrentPage} ps={ps} />;
      case 'careers':     return <CareersPage     setCurrentPage={setCurrentPage} ps={ps} />;
      case 'contact':     return <ContactPage     ps={ps} />;
      default:            return <HomePage        setCurrentPage={setCurrentPage} ps={ps} />;
    }
  };
