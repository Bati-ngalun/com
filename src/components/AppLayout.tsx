...
const IMAGES = {
	...
	hero3: "<img src={`${import.meta.env.BASE_URL}images/home.jpg`} alt="Home" />",
						...
						{filteredProjects.map((project) => (
							...
							>
								<div className="relative h-80 overflow-hidden">
									...
									<span
										className={`absolute top-4 left-4 px-3 py-1 text-white text-xs font-medium rounded-full ${project.category === "water" ? "bg-[#0077BE]" : project.category === "realestate" ? "bg-amber-600" : project.category === "agriculture" ? "bg-[#2D5016]" : "bg-rose-600"}`}
									>
			...
			<section className="py-16 bg-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="bg-gray-200 rounded-xl overflow-hidden h-96">
						<iframe
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62036.41567285!2d-16.6291!3d13.4549!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xec29c2a1d6e5555%3A0x5c6e5d5e5d5e5d5e!2sMarakissa%2C%20The%20Gambia!5e0!3m2!1sen!2s!4v1234567890"
							width="100%"
							height="100%"
							style={{ border: 0 }}
							allowFullScreen
